...
TEST(DnsDecoder, ParsesResponseWithARecord) {
    ...
    data.push_back(0xC0); data.push_back(0x0C);  // name pointer
    data.push_back(0x00); data.push_back(0x01);  // type: A
    data.push_back(0x00); data.push_back(0x01);  // class: IN
    ...
    data.push_back(0x5D); data.push_back(0xB8);
    data.push_back(0xD8); data.push_back(0x22);  // RDATA: 93.184.216.34
...
TEST(DnsDecoder, ParsesAAAARecord) {
    ...
    data.insert(data.end(), qname.begin(), qname.end());
    data.push_back(0x00); data.push_back(0x1C);  // type: AAAA (28)
    data.push_back(0x00); data.push_back(0x01);  // class: IN

    // Answer: AAAA record
    data.push_back(0xC0); data.push_back(0x0C);  // name pointer
    data.push_back(0x00); data.push_back(0x1C);  // type: AAAA
    data.push_back(0x00); data.push_back(0x01);  // class: IN
    data.push_back(0x00); data.push_back(0x00);
    data.push_back(0x00); data.push_back(0x3C);  // TTL: 60
    data.push_back(0x00); data.push_back(0x10);  // RDLENGTH: 16
...
TEST(DnsDecoder, ParsesNXDOMAINResponse) {
    ...
    std::vector<uint8_t> data = {
        0x56, 0x78,
        0x81, 0x83,  // response, RD=1, RA=1, RCODE=NXDOMAIN (3)
        0x00, 0x01,  // QDCOUNT: 1
        0x00, 0x00,  // ANCOUNT: 0
        0x00, 0x00,
        0x00, 0x00,
